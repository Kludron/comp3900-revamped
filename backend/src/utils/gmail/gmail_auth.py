...
def test_api_request():
    ...
    sentEmail = sendEmail('nathan.quan5@gmail.com', 'message: testing authentication')
...
def authorize():
  ...
  # error.
  flow.redirect_uri = flask.url_for('do_oauth2callback', _external=True)
...
def oauth2callback():
  ...
  return flask.redirect(flask.url_for('do_test_api_request'))
...
def sendEmail(toEmail, email_msg):
    if 'credentials' not in flask.session:
        return flask.redirect('authorize')
