...
cursor = conn.cursor()
cursor.execute("INSERT INTO users(id, username, pass_hash, email) VALUES (%s, %s, %s, %s);", (1, "Sample", str(sha256(str("password"+SALT).encode('utf-8')).hexdigest()), "sample@sample.com"))
conn.commit()
